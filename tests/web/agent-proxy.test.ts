...
describe('agent proxy routes', () => {
  ...
  it('proxies SSE stream requests', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/stream?orgSlug=demo&question=Hi'),
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/stream?orgSlug=demo&question=Hi') },
    );
  ...
  it('returns error when agent service URL missing', async () => {
    const { GET } = await import('../../apps/web/app/api/agent/stream/route');
    const request = Object.assign(new Request('https://app.prismaglow.example.com/api/agent/stream'), {
      nextUrl: new URL('https://app.prismaglow.example.com/api/agent/stream'),
    });
    const response = await GET(request as any);
  ...
  it('proxies orchestrator plan requests', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/orchestrator/plan', {
        method: 'POST',
      ...
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/orchestrator/plan') },
    );
  ...
  it('proxies realtime session requests', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/realtime/session', {
        method: 'POST',
        body: JSON.stringify({ orgSlug: 'demo' }),
        headers: { 'content-type': 'application/json' },
      }),
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/realtime/session') },
    );
  ...
  it('proxies orchestrator session creation', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/orchestrator/session', {
        method: 'POST',
        body: JSON.stringify(payload),
        headers: { 'content-type': 'application/json', cookie: 'session=xyz' },
      }),
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/orchestrator/session') },
    );
  ...
  it('proxies orchestrator session board fetch', async () => {
    ...
    const request = Object.assign(new Request('https://app.prismaglow.example.com/api/agent/orchestrator/session/session-1'), {
      nextUrl: new URL('https://app.prismaglow.example.com/api/agent/orchestrator/session/session-1'),
    });
  ...
  it('proxies orchestrator task completion', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/orchestrator/tasks/task-1/complete', {
        method: 'POST',
        body: JSON.stringify({ status: 'COMPLETED' }),
        headers: { 'content-type': 'application/json' },
      }),
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/orchestrator/tasks/task-1/complete') },
    );
  ...
  it('proxies orchestrator session list', async () => {
    ...
    const request = Object.assign(
      new Request('https://app.prismaglow.example.com/api/agent/orchestrator/sessions?orgSlug=demo'),
      { nextUrl: new URL('https://app.prismaglow.example.com/api/agent/orchestrator/sessions?orgSlug=demo') },
    );
