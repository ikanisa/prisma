...
- **Shared staging** – mirror the same variables in the deployment secrets (Docker Compose/Kubernetes or GitHub Actions) plus the OpenAI API key and optional base URL/organization overrides.
