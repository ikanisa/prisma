...
import { Calculator, DollarSign, TrendingUp, FileSpreadsheet, Calendar, Sparkles } from 'lucide-react';
...
export default function AccountingPage() {
  ...
  return (
    <>
          ...
          <div className="divide-y divide-border">
            {closingTasks.map((task) => (
              ...
              >
                ...
                <span
                  className={`rounded-full px-2 py-0.5 text-xs font-medium ${task.status === 'completed'
      ...
      <AISidebar
        category="accounting"
        title="IFRS/GAAP Assistant"
        placeholder="Ask about revenue recognition, leases, consolidation..."
      />
    </>
  );
}
