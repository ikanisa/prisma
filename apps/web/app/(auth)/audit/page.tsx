...
import { ClipboardCheck, Plus, AlertTriangle, CheckCircle, Clock, FileText, Sparkles } from 'lucide-react';
  ...
  return (
    <>
          ...
          <div className="divide-y divide-border">
            {findings.map((finding) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`rounded-lg p-2 ${finding.severity === 'high'
                  ...
                  >
                    <AlertTriangle
                      className={`h-5 w-5 ${finding.severity === 'high'
                ...
                <span
                  className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${finding.severity === 'high'
      ...
      <AISidebar
        category="audit"
        title="ISA Expert"
        placeholder="Ask about ISA 315, materiality, audit procedures..."
      />
    </>
  );
}
