...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return <div className="space-y-3 animate-fade-in">
      ...
      <div className="relative">
        <Input ref={inputRef} id="phone" value={value} onChange={handleInputChange} onFocus={handleFocus} onBlur={handleBlur} placeholder="Enter Phone Number or Code…" className={`
