...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return <div className="space-y-3 animate-fade-in">
      <Label htmlFor="phone" className="text-base font-semibold text-gray-800 dark:text-gray-200">
      ...
      <div className="relative">
        ...
        {value && <button type="button" onClick={clearPhone} onMouseDown={e => e.preventDefault()} className={`
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        {value && value.length >= 4 && <span className="text-blue-600 dark:text-blue-400 font-semibold">
            {value.length >= 10 ? 'MoMo Number' : 'Pay Code'}
          </span>}
      </div>
      
      {/* Validation hints */}
      {value && value.length > 0 && value.length < 4 && <div className="text-xs text-orange-500 dark:text-orange-400">
