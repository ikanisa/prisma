...
export default function TripsIntentsUnified() {
  ...
  async function loadData() {
    ...
    try {
      ...
      // Fetch passenger intents
      const { data: passengerIntents } = await supabase
