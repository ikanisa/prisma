        ...
        <div className="flex flex-col items-center justify-center min-h-screen space-y-8">
          ...
          <div className="text-center animate-fade-slide">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 font-semibold">
              Send & Receive Money. Instantly. Privately.
            </p>
          </div>
          ...
          <div className="w-full max-w-md space-y-6">
            ...
            <button
              ...
              className="w-full btn-secondary ripple flex items-center justify-center space-x-4"
            >
          ...
          <div className="flex space-x-6">
            <button
              onClick={handleShare}
              className="glass-card p-4 hover:scale-110 transition-transform duration-200"
