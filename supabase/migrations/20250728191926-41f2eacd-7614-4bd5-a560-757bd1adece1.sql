...
CREATE INDEX IF NOT EXISTS idx_user_behavior_patterns_phone ON public.user_behavior_patterns(phone_number);
CREATE INDEX IF NOT EXISTS idx_learning_gap_instances_phone ON public.learning_gap_instances(phone_number);
