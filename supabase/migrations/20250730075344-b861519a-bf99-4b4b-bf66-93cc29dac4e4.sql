...
-- Create RLS policies for performance benchmarks
CREATE POLICY "System can manage performance benchmarks" 
...
CREATE INDEX IF NOT EXISTS idx_qa_test_runs_created_at ON qa_test_runs(created_at);
CREATE INDEX IF NOT EXISTS idx_validation_logs_type ON system_validation_logs(validation_type);
CREATE INDEX IF NOT EXISTS idx_validation_logs_status ON system_validation_logs(status);
CREATE INDEX IF NOT EXISTS idx_phase_completion_phase ON phase_completion_log(phase);
