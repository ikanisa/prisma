-- ===================================================================
-- PostGIS setup + helper RPCs + Row-Level Security (easyMO Trips) - FIXED v2
-- ===================================================================
...
-- 2. Enhanced driver_trips table (add missing columns if they don't exist)
DO $$
BEGIN
...
DROP FUNCTION IF EXISTS public.fn_get_nearby_drivers;
DROP FUNCTION IF EXISTS public.fn_get_nearby_passengers;

-- 6. Enhanced RPC: Get nearby drivers for passengers (FIXED)
...
-- 7. RPC: Get nearby passengers for drivers (FIXED)
...
-- 10. Allow public read access for active trips (for matching)
...
-- 11. Update existing trips_and_intents view to use new columns
