-- Security Fix 1: Drop and recreate is_bar_staff function with proper security
DROP FUNCTION IF EXISTS public.is_bar_staff(uuid);
...
-- Security Fix 2: Fix is_admin function with proper security
