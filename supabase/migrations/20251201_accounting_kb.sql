-- Accounting Knowledge Base Schema Migration
-- Date: 2025-12-01
-- Description: Core tables for IFRS/IAS/ISA/GAAP/Tax Laws knowledge management with RAG support
...
comment on table jurisdictions is 'Countries and regions for jurisdiction-specific accounting/tax rules';

-- 3) Knowledge sources (IFRS, IAS, ISA, GAAP, Tax laws, ACCA, etc.)
...
comment on table knowledge_chunks is 'Text chunks for RAG retrieval, extracted from knowledge documents';
...
comment on table agent_queries_log is 'Audit trail of agent knowledge base queries';
