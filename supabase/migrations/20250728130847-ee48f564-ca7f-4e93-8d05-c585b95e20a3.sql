-- Create incoming_messages table to store WhatsApp messages
...
CREATE INDEX IF NOT EXISTS idx_incoming_messages_from_number ON public.incoming_messages(from_number);
