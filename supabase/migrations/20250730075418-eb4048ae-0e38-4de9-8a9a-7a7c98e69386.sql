...
-- Create performance benchmarks table (corrected)
...
-- Create indexes for performance (corrected column references)
...
CREATE INDEX IF NOT EXISTS idx_performance_benchmarks_name ON public.performance_benchmarks(benchmark_name);
