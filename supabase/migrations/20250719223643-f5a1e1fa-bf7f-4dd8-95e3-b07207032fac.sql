-- ===================================================================
-- PostGIS setup + helper RPCs + Row-Level Security (easyMO Trips) - FIXED
-- ===================================================================
...
-- 5. Enhanced RPC: Get nearby drivers for passengers (FIXED ROUND FUNCTION)
...
-- 6. RPC: Get nearby passengers for drivers (FIXED ROUND FUNCTION)
