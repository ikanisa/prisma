...
export type Database = {
    ...
    public: {
        ...
        Enums: {
            ...
            approval_status: "PENDING" | "APPROVED" | "CHANGES_REQUESTED" | "REJECTED" | "CANCELLED";
            ...
            agent_orchestration_status: "PENDING" | "RUNNING" | "WAITING_APPROVAL" | "COMPLETED" | "FAILED";
            agent_task_status: "PENDING" | "ASSIGNED" | "IN_PROGRESS" | "AWAITING_APPROVAL" | "COMPLETED" | "FAILED";
            audit_risk_category: "FINANCIAL_STATEMENT" | "FRAUD" | "CONTROL" | "IT" | "GOING_CONCERN" | "COMPLIANCE" | "ESTIMATE" | "OTHER";
            ...
            je_control_rule: "LATE_POSTING" | "WEEKEND_USER" | "ROUND_AMOUNT" | "MANUAL_TO_SENSITIVE" | "MISSING_ATTACHMENT";
            ...
            reconciliation_item_category: "DIT" | "OC" | "UNAPPLIED_RECEIPT" | "UNAPPLIED_PAYMENT" | "TIMING" | "ERROR" | "OTHER";
...
export declare const Constants: {
    ...
    readonly public: {
        readonly Enums: {
            readonly agent_action_status: readonly ["PENDING", "SUCCESS", "ERROR", "BLOCKED"];
            readonly agent_orchestration_status: readonly ["PENDING", "RUNNING", "WAITING_APPROVAL", "COMPLETED", "FAILED"];
            readonly agent_run_state: readonly ["PLANNING", "EXECUTING", "DONE", "ERROR"];
            readonly agent_task_status: readonly ["PENDING", "ASSIGNED", "IN_PROGRESS", "AWAITING_APPROVAL", "COMPLETED", "FAILED"];
            readonly agent_trace_type: readonly ["INFO", "TOOL", "ERROR"];
            readonly audit_risk_category: readonly ["FINANCIAL_STATEMENT", "FRAUD", "CONTROL", "IT", "GOING_CONCERN", "COMPLIANCE", "ESTIMATE", "OTHER"];
            readonly cit_refund_profile: readonly ["6_7", "5_7", "2_3", "NONE"];
            readonly close_period_status: readonly ["OPEN", "SUBSTANTIVE_REVIEW", "READY_TO_LOCK", "LOCKED"];
            readonly engagement_status: readonly ["planned", "active", "completed", "archived"];
            readonly fraud_plan_status: readonly ["DRAFT", "READY_FOR_APPROVAL", "LOCKED"];
            readonly je_control_rule: readonly ["LATE_POSTING", "WEEKEND_USER", "ROUND_AMOUNT", "MANUAL_TO_SENSITIVE", "MISSING_ATTACHMENT"];
            readonly je_control_severity: readonly ["LOW", "MEDIUM", "HIGH"];
            readonly ledger_account_type: readonly ["ASSET", "LIABILITY", "EQUITY", "REVENUE", "EXPENSE"];
            readonly org_role: readonly ["admin", "manager", "staff", "client"];
            readonly reconciliation_item_category: readonly ["DIT", "OC", "UNAPPLIED_RECEIPT", "UNAPPLIED_PAYMENT", "TIMING", "ERROR", "OTHER"];
            readonly reconciliation_type: readonly ["BANK", "AR", "AP", "GRNI", "PAYROLL", "OTHER"];
            readonly response_status: readonly ["PLANNED", "IN_PROGRESS", "COMPLETED", "CANCELLED"];
            readonly response_type: readonly ["CONTROL", "SUBSTANTIVE", "ANALYTICS", "SAMPLING", "OTHER"];
            readonly risk_rating: readonly ["LOW", "MODERATE", "HIGH", "SIGNIFICANT"];
            readonly risk_status: readonly ["OPEN", "MONITORED", "CLOSED"];
            readonly role_level: readonly ["EMPLOYEE", "MANAGER", "SYSTEM_ADMIN"];
            readonly severity_level: readonly ["info", "warn", "error"];
            readonly tax_account_type: readonly ["MTA", "FIA", "IPA", "FTA", "UA"];
        };
    };
};
export {};
