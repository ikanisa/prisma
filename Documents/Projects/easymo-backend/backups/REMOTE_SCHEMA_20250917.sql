...
CREATE OR REPLACE FUNCTION "public"."nearby_businesses"("_lat" double precision, "_lon" double precision, "_viewer" "text", "_limit" integer) RETURNS TABLE("id" "uuid", "name" "text", "description" "text", "distance_km" numeric)
    LANGUAGE "sql" STABLE
    AS $$
  ...
  select
    ...
    (ST_Distance(b.geo, pt.g) / 1000.0)::numeric as distance_km
...
ALTER FUNCTION "public"."nearby_businesses"("_lat" double precision, "_lon" double precision, "_viewer" "text", "_limit" integer) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."nearby_businesses"("_lat" double precision, "_lon" double precision, "_viewer" "text", "_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."nearby_businesses"("_lat" double precision, "_lon" double precision, "_viewer" "text", "_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."nearby_businesses"("_lat" double precision, "_lon" double precision, "_viewer" "text", "_limit" integer) TO "service_role";
